...
export default function Form() {
  ...
  const items = [
    { value: "City", type: "text", placeholder: " " },
    { value: "County", type: "text", placeholder: " " },
    { value: "Photo", type: "text", placeholder: "" },
    { value: "Population", type: "number", placeholder: "",
    },
    { value: "Details: ", type: "text", placeholder: "" },
    { value: "Fundation: ", type: "date", placeholder: "" , id: "fundation"},
  ];
  ...
  const Cities = [
    {
      ...
      city: "Thirty three",
      photo:
        "https://i.pinimg.com/originals/b5/ca/d4/b5cad4a6c14ef65bd11bfb36f2cd1f84.jpg",
      country: "Uruguay",
    ...
    },
    {
      ...
      photo:
        "https://i2-prod.mirror.co.uk/incoming/article3884411.ece/ALTERNATES/n615/NO-REUSE-MAIN-Paul-Grant.jpg",
      population: 6969,
    ...
    },
    {
      ...
      country: "England",
      photo:
        "https://i0.wp.com/imgs.hipertextual.com/wp-content/uploads/2016/07/landscape-1433777123-hogwarts-school-of-witchcraft-and-wizardry-harry-potter-movie-hd-wallpaper-1920x1080-4707.jpg?fit=1600%2C800&quality=50&strip=all&ssl=1",
      population: 1111171,
